...
void man(char *name){
    ...
    }else if (strcmp(name,"lseek")==0)
    {
        ...
        printf("Usage : lseek File_Name ChangeInOffset StarPoint\n");
...
int CreateFile(char *name, int permisiion){
    int i=0;
    PINODE temp=head;

    if((name==NULL)||(permisiion==0)||(permisiion>3))
    return -1;
    ...
    UFDTArr[i].ptrfiletable->mode=permisiion;
    ...
    UFDTArr[i].ptrfiletable->ptrinode->permission=permisiion;
...
int fstat_file(int fd){
    ...
    printf("File Permision : Read & Write\n");
    ...
    while (1)
    {
        ...
        }else if(count==3)
        {
            ...
            }else if(strcmp(command[0],"read")==0)
            {
                ...
                if(ret ==-2)
                    printf("ERROR : Permisiion denied\n");
                if(ret ==-3)
